        ...
        <?php
            ...
            if (isset($_GET['edit-pelanggan'])) {
                if ($_GET['edit-pelanggan']=='berhasil'){
                    echo"<div class='alert alert-success'><strong>Berhasil!</strong> Anggota yang meminjam barang berhasil diupdate</div>";
                } else if ($_GET['edit-pelanggan']=='gagal'){
                    echo"<div class='alert alert-danger'><strong>Gagal!</strong> Anggota yang meminjam barang gagal diupdate</div>";
                }   
            }
        ?>
        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table table">
                                    ...
                                    <?php
                                        ...
                                        $sql="select *
                                        from transaksi p
                                        left join anggota an on an.kodePelanggan=p.kodePelanggan
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <button class="btn btn-warning btn-circle" id="tombol_edit_anggota" kodeTransaksi="<?php echo $_GET['kodeTransaksi'];?>"  kodePelanggan="<?php echo $ambil['kodePelanggan'];?>" ><i class="fas fa-edit"></i></button>
